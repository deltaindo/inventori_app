...
<script>
  function deleteJurnalBarang(id) {
    Swal.fire({
      title: "Are you sure?",
      text: "You won't be able to revert this!",
      icon: "warning",
      ...
      if (result.isConfirmed) {
        ...
        window.location.href = `<?= base_url('/dashboard/delete_jurnal_barang/') ?>${id}`;
      }
    });
  }
</script>
...
<script>
  function bulkDeleteJurnalBarang() {
    Swal.fire({
      title: "Are you sure?",
      text: "You won't be able to revert this!",
      icon: "warning",
...
<script>
  function deleteJurnalBarangMasuk(id) {
    Swal.fire({
      title: "Are you sure?",
      text: "You won't be able to revert this!",
      icon: "warning",
      ...
      if (result.isConfirmed) {
        ...
        window.location.href = `<?= base_url('/dashboard/delete_jurnal_barang_masuk/') ?>${id}`;
      }
    });
  }
</script>
...
<script>
  function bulkDeleteJurnalBarangMasuk() {
    Swal.fire({
      title: "Are you sure?",
      text: "You won't be able to revert this!",
      icon: "warning",
  ...
  function deleteDivisi(id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        window.location.href = `<?= base_url('/dashboard/delete_divisi/') ?>${id}`;
      }
    });
  }
</script>
  ...
  function deleteKaryawan(id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        window.location.href = `<?= base_url('/dashboard/delete_karyawan/') ?>${id}`;
      }
    });
  }
</script>
