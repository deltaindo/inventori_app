        ...
        <div class="col-sm-12">
            <div class="row tabel-produk">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <form method="post" action="<?= base_url('dashboard/simpan_jurnal_alat_tulis_kantor'); ?>">
                            <div class="card-body">
                                <div class="card-footer d-flex justify-content-between">
                                    <div class="d-flex">
                                        <h4 class="card-title">
                                            Tambah Jurnal Alat Tulis Kantor
                                        </h4>
                                    </div>
                                    <div class="d-flex">
                                ...
                                <label for="jumlah_pengambilan" class="text-primary fs-6 mb-1">
                                    Jumlah Pengambilan
                                </label>
                                <div class="mb-1">
                                ...
                                <div class="mb-1">
                                    ...
                                    <span class="text-small">
                                        <i>
                                            Contoh: Buku Agenda digunakan untuk keperluan kerja.
                                        </i>
                                    </span>
                                </div>
                            </div>
