                        ...
                        <div class="card">
                            <form method="post" action="<?= base_url('dashboard/update_jurnal_alat_peraga/' . $alat_peraga['id']); ?>">
                                <div class="card-body">
                                    ...
                                    <div class="mb-1">
                                        <textarea id="keterangan_masuk_barang" name="keterangan_barang" cols="300" rows="10" class="form-control" style="height: 50px;" placeholder="Inputkan Keterangan Alat Peraga"><?= $alat_peraga['keterangan']; ?></textarea>
                                        <span class="text-small">
                                            <i>
