                            ...
                            <div class="tab-content tab-content-basic">
                                ...
                                <div class="row tabel-produk mt-2">
                                    <div class="col-lg-8 grid-margin stretch-card">
                                        <div class="card">
                                            <form method="post" action="<?= base_url('dashboard/simpan_lokasi'); ?>">
                                                <div class="card-body">
                                                    <h4 class="card-title">
                                                        Tambah Data Lokasi
                                                    </h4>
                                                    ...
                                                    <div class="mb-3">
                                                        <input type="text" class="form-control" name="nama_lokasi" placeholder="Inputkan Nama lokasi" autofocus>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <textarea name="keterangan_lokasi" cols="300" rows="10" class="form-control" style="height: 100px;" placeholder="Inputkan Keterangan Lokasi"></textarea>
                                                    </div>
                                                </div>
