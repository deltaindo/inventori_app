                                        ...
                                        <div class="card">
                                            <form method="post" action="<?= base_url('dashboard/update_lokasi/' . $lokasi['id']); ?>">
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <input type="text" class="form-control" name="nama_lokasi" value="<?= $lokasi['nama_lokasi']; ?>" placeholder="Nama lokasi..." autofocus>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <textarea name="keterangan_lokasi" cols="300" rows="10" class="form-control" style="height: 100px;" placeholder="Keterangan Lokasi..."><?= $lokasi['keterangan']; ?></textarea>
                                                    </div>
                                                </div>
