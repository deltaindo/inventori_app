                 ...
                 <?php foreach($produk as $p) : ?> 
                  ...
                  <li class="list-group-item mt-3">
                        ...
                        <div class="row">
                            ...
                            <input type="text" class="form-control" name="stok[]" id="exampleInputPassword1" value="<?= $p['jumlah'] ?>">
                            </div>
                            <!-- <div class="col-4">
                            <label for="exampleInputPassword1" class="form-label">Stok Awal</label>
                            <input type="text" class="form-control" name="awal[]" id="exampleInputPassword1"  value="<?= $p['stok_awal'] ?>">
                            </div>
                            <div class="col-4">
                            <label for="exampleInputPassword1" class="form-label">Barang Masuk</label>
                            <input type="text" class="form-control" name="masuk[]" id="exampleInputPassword1" value="<?= $p['masuk'] ?>">
                            </div>
                            <div class="col-4 d-none">
                            <label for="exampleInputPassword1" class="form-label">Barang Masuk</label>
                            <input type="hidden" class="form-control" name="keluar[]" id="exampleInputPassword1"  value=0>
                            </div>
                            <div class="col-4">
