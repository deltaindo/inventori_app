<div class="main-panel">
                  ...
                  >
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li class="nav-item ml-auto">
                        <p class="nav-link text-primary">Total Seluruh Aset : <?= ($total == 0) ? '0' : 'Rp '. number_format($total,0,',','.'); ?></p>
                      </li>
                      <li class="nav-item ml-auto">
        ...
        <div class="row tabel-produk mt-2">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                <h4 class="card-title">Daftar <?= $tittle; ?> <?= ($this->gudang == 1) ? 'DIP' : 'DNP'; ?></h4>
                  ...
                  <button class="btn btn-primary btn-sm text-white" type="submit">Stok Opname</button>
                   <a href="tambah_produk.html" class="btn btn-danger text-white" id="hapus-kantor" data-url="<?= base_url('dashboard/hapus_kantor') ?>"  >Hapus</a>
