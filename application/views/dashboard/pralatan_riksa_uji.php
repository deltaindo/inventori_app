        ...
        <div class="home-tab">
          <div class="d-sm-flex align-items-center justify-content-between border-bottom">
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                <a class="nav-link active ps-0 inventori" href="<?= base_url('dashboard/daftar_produk'); ?>" role="tab" aria-controls="overview" aria-selected="true">
                  Pralatan Praktik
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link active ps-0 inventori" id="" href="<?= base_url('dashboard/pralatan_riksa_uji'); ?>" role="tab" aria-controls="overview" aria-selected="true">
                  Pralatan Riksa Uji
                </a>
              </li>
            ...
            <div>
              <div class="btn-wrapper">
                ...
                <a href="<?= base_url('dashboard/import_praktek'); ?>" class="btn btn-primary text-white me-0" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="icon-download"></i>Import</a>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-lg-4 info-pengeluaran">
                <div class="card">
                  <div class="card-body">
                    <P class="text-danger">
                      Total Barang Kalibrasi Expired : <?= $kalibrasi; ?>
                    </P>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 info-pengeluaran">
                <div class="card">
                  <div class="card-body">
                    <form action="<?= base_url('dashboard/pralatan_riksa_uji'); ?>" method="post">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="<?= base_url('dashboard/opname_peralatan'); ?>" method="post">
                    ...
                    <a href="#" class="btn btn-danger btn-sm text-white" id="hapus-praktek" data-url="<?= base_url('dashboard/hapus_praktek'); ?>">
                      Hapus
                    </a>
