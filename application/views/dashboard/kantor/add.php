                                ...
                                <div class="card">
                                    <form method="post" action="<?= base_url('dashboard/simpan_kantor'); ?>">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" class="form-control" name="nama_kantor" placeholder="Inputkan Nama Kantor" autofocus>
                                            </div>
                                            <label for="keterangan_kantor" class="text-primary fs-6 mb-1">
                                                Keterangan
                                            </label>
                                            <div class="mb-3">
                                                <textarea name="keterangan_kantor" cols="300" rows="10" class="form-control" style="height: 100px;" placeholder="Inputkan Keterangan Kantor"></textarea>
                                            </div>
                                        </div>
